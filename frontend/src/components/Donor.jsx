...
function Donor({ userName, onLogout }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.success) {
                setMessage({ type: 'success', text: 'Registration successful! Thank you for being a donor.' })
                setFormData({
                    name: userName || '',
                    age: '',
                    bloodGroup: '',
    ...
    return (
        <div className="max-w-2xl mx-auto px-7 py-7 bg-gray-50 rounded-lg shadow-md">
            <div className="text-center mb-7">
                <h2 className="text-2xl font-bold text-red-600 m-0 mb-2">Register as Donor</h2>
                <p className="text-gray-600 m-0 text-sm">Welcome, {userName}! Help save lives by registering as a blood donor.</p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
                <div className="mb-5">
                    ...
                    <input
                        ...
                        disabled
                        className="w-full px-3 py-3 border border-gray-300 rounded text-sm transition-all duration-300 focus:outline-none focus:border-red-600 focus:ring focus:ring-red-200 disabled:bg-gray-100 disabled:cursor-not-allowed disabled:text-gray-600"
                    />
                </div>
